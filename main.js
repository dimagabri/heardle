  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-2"> Il nuovo Heardle, ma le canzoni non sono solo italiane. Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.</p> <p class="mb-3"> Prova le nostre Favolose Special Week! <p class="mb-3"> </p> <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 18.07.2024'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
...
{ url:"https://soundcloud.com/vasco-rossi-official/gli-spari-sopra-celebrate", answer:"Vasco Rossi - Gli spari sopra (Celebrate)", },
...
{ url:"https://soundcloud.com/raffaella-carra-official/pedro", answer:"Raffaella Carrà - Pedrò", },
 ],
        Pn
      ).subscribe,
    };
