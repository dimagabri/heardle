  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno: </br> - 21.07-27.07 Non ti facevo così demenziale... </br> - 28.07-03.08 Dovresti guardare meno TV. </br> - 04.08-10.08 Il fantasma delle estati passate </br> - 11.08-17.08 Il fantasma di questa estate </br> - 18.08-24.08 Estati ancora più passate! </br> - 25.08-31.08 Avete vinto voi: Dance anni 90! </br> - 08.09-14.09 Settembre è sempre difficile </br> - 15.09-21.09 È un fatto geografico a volte </br> - 29.09-05.10 Per caso c&apos;è un concerto al Forum?  <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 22.07.2025</br> Il gioco finirà un giorno di gennaio.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
