  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno: </br> - Dal 16.01: Il Finale: É GABBISMO SIGNORI. <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 11.01.2026</br> Il gioco finirà un giorno di gennaio.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
...
{ url:"https://soundcloud.com/dean-martin-official/white-christmas-2", answer:"Dean Martin - White Christmas", },
