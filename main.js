  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
             '<p class="mb-2"> Il nuovo Heardle, ma le canzoni non sono solo italiane. Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno: </br> - Dal 22.07 al 28.07: Estate Moderna </br> - Dal 19.08 al 25.08: Estate nostalgica! <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 18.07.2024'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
...
{ url:"https://soundcloud.com/frankiehi-nrgmc/quelli-che-benpensano", answer:"Frankie HI-NRG - Quelli che benpensano", },
