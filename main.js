  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno:  </br> - 06.01-12.01: Noo, quelli con il casco noooo! </br> - 23.01-29.01: La sorpresa meno sorpresa di sempre </br> - 03.02-09.02: Come te la cavi con le colonne sonore?	 </br> - 17.02-23.02: Sanremo era meglio prima </br> - 03.03-09.03: Altra botta di anni 80 dai! </br> - 10.03-16.03: Pure le serie TV adesso <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 16.12.2024</br> Le canzoni arrivano fino all'11 maggio, per ora...'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
