  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno:  </br> - Dal 02.12 al 08.12: Ancora Lucio? Ma non dovevamo... ah già  </br> - Dal 06.01 al 12.01: Noo, quelli con il casco noooo! </br> - Dal 23.01 al 29.01: La sorpresa meno sorpresa di sempre <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 21.10.2024</br> Le canzoni arrivano fino al 14 aprile, per ora...'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
