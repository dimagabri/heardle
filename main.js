  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno:  </br> - 13.10-19.10 Ti ricordi quando andavamo a ballare? </br> - 20.10-26.10 Indi...nuovo?  </br> - 03.11-09.11 Secondo me sono sopravvalutati, ma ok. </br> - 10.11-16.11 Siamo arrivati a questo: la Disney. </br> - 24.11-30.11 Questa me l&#39;ero scordata!  <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 12.10.2025</br> Il gioco finirà un giorno di gennaio.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
