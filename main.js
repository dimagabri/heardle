  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
                        '<p class="mb-2"> Il nuovo Heardle e le canzoni non sono solo italiane! Creato con orgoglio da <a href="https://instagram.com/dimagabri">@dimagabri</a>. <p class="mb-3"> Tutti i diritti vanno ai rispettivi proprietari.<p class="mb-3"> Prova le nostre Favolose Special Week: settimane a tema, suggerite dai giocatori...oppure che rispecchiano il clima! <p class="mb-3"> Le prossime saranno: - 24.03-30.03: Claudiooooo!</br> - 07.04-13.04 Che giorno è? </br> - 19.05-25.05 Gli anni 10 sono stati una cosa. </br> - 02.06-08.06 Gli anni zero invece...<p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://www.netlify.com//">Netlify</a>. Release 16.02.2025</br> Le canzoni arrivano fino a maggio, per ora...'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
...
{ url:"https://soundcloud.com/maroon-5/sets/moves-like-jagger", answer:"Maroon 5, Christina Aguilera - Moves Like Jagger", },
